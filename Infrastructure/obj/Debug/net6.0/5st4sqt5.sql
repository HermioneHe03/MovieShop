...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20220525175206_InitialMigration')
BEGIN
    CREATE TABLE [Cast] (
        [Id] int NOT NULL IDENTITY,
        [Name] nvarchar(128) NULL,
        [Gender] nvarchar(2084) NULL,
...
BEGIN
    CREATE TABLE [Genres] (
        ...
        CONSTRAINT [FK_Genres_Movie_MovieId] FOREIGN KEY ([MovieId]) REFERENCES [Movie] ([Id])
    );
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20220525175206_InitialMigration')
BEGIN
    CREATE INDEX [IX_Genres_MovieId] ON [Genres] ([MovieId]);
END;
GO
...
BEGIN
    ...
    VALUES (N'20220525175206_InitialMigration', N'6.0.5');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20220525183645_updatingMovieTable')
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20220525183645_updatingMovieTable', N'6.0.5');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20220525185241_UpdateGenreName')
BEGIN
    ALTER TABLE [Genres] DROP CONSTRAINT [FK_Genres_Movie_MovieId];
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20220525185241_UpdateGenreName')
BEGIN
    EXEC sp_rename N'[Genre].[IX_Genres_MovieId]', N'IX_Genre_MovieId', N'INDEX';
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20220525185241_UpdateGenreName')
BEGIN
    ALTER TABLE [Genre] ADD CONSTRAINT [FK_Genre_Movie_MovieId] FOREIGN KEY ([MovieId]) REFERENCES [Movie] ([Id]);
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20220525185241_UpdateGenreName', N'6.0.5');
END;
GO
